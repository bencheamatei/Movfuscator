...
Implementarea noastră a movfuscatorului nu convertește instrucțiunile de jump (implicit de compare), iar operațiile artimetice și logice trebuie să fie realizate pe 32 de biți.
